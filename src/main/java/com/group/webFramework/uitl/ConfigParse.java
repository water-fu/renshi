...
public class ConfigParse {
	...
	private static InputStream loadFile(String fileName) {
		...
		try {
			...
			logger.info("将从位置[" + filePath + "]加载数据库配置文件。");
			in = new FileInputStream(file);
		} catch (Exception e) {
			logger.info("从位置[" + filePath + "]没有加载到数据库配置文件，将从类路径加载。");
	 ...
	 */
	public static final Map<String, String> parseConfig(String fileName, String[] configs)
			throws ApplicationException {
