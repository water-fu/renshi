...
<body>
			...
			<div class="reg-right">
				<div class="reg-con">
					<form action="" method="post" id="loginForm">
						<p class="title"><span></span><em>代理商登录</em></p>
						...
						<p class="default">
							...
							<input type="text" name="loginAccount" id="useraccount" placeholder="邮箱/手机号">
						</p>
						...
						<p class="get-register"><span>尚未注册代理商账号?</span><a href="javascript:void(0)" id="toRegister">请先注册&gt;&gt;</a></p>
					</form>
				</div>
			</div>
		</div>
	...
	<script src="${jsPath}/proxy/login.js"></script>
</body>
</html>