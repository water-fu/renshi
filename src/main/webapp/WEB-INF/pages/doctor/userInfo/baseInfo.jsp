				...
				<div class="userInfo-con">
					...
					<div class="base">
						...
						<div class="area">
							...
							<p>
								<label>现居城市:</label>
								<select class="mf" id="country" name="country">
							...
							<div id="header">
								...
								<div id="upload" class="mf">
									...
									<div id="view">
										<img id="headImg" class="preImg" alt="" src="">
										<p>头像预览</p>
									</div>
					...
					<div class="profess">
						<div class="intro">
							...
							<p class="desc"><em>以下信息将彰显您的专业和权威，将在您的个人主页中展示</em></p>
						</div>
						...
						<div class="area">
							...
							<p>
								...
								<input type="text" id="inputHospital" name="belongHospital" placeholder="医院"
								       class="mf" >
					...
					<div class="contact">
						<div class="intro">
							...
							<p class="desc"><em>以下信息默认仅用于认仕网跟您联系时使用，我们不会泄漏您的个人信息</em></p>
						</div>
...
<script type="text/javascript" src="${jsPath}/doctor/baseInfo.js"></script>
	<script type="text/javascript" src="${jsPath}/system/zone.js"></script>
	<script type="text/javascript">
	addressInit('province','city','livearea','浙江省','杭州市','西湖区-330100');
	</script>
</html>