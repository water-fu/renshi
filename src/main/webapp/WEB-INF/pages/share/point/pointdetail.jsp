...
<head>
	...
	<link rel="stylesheet" href="${cssPath}/point/pointdetail.css">
...
<%@ include file="/WEB-INF/pages/common/header.jsp" %>
		...
		<div class="answ-detail">
			...
			<div class="detail-time mar-com">
				<p><a href="${path}/blog/${shareInfoBean.accountId}"><strong>${shareInfoBean.realName}</strong></a><span>发布于<em><fmt:formatDate value="${shareInfoBean.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></em>的观点</span></p>
			</div>
		...
		<div class="content">
			...
			<div class="con-right f-right">
				<div class="inter-case ">
					<h4>您可能感兴趣的观点</h4>
					 <div class="case-list" id="point_infos_Content"> 
