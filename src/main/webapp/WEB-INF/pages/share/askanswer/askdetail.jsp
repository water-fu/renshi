...
<head>
	...
	<link rel="stylesheet" href="${cssPath}/askanswer/askdetail.css">
</head>
<body>
<%@ include file="/WEB-INF/pages/common/header.jsp" %>
		...
		<!-- scroll end -->
		<input id="shareId" type="hidden" value="${shareInfoBean.shareId}" />
		
		<div class="answ-detail">
			<div class="detail-title mar-com">
				<strong>${shareInfoBean.shareTitle}</strong>
				<ul class="f-right">
			...
			<div class="detail-time mar-com">
				<p><a href="${path}/blog/${shareInfoBean.accountId}"><strong>${shareInfoBean.realName}</strong></a><span>发布于<em><fmt:formatDate value="${shareInfoBean.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/> </em>的提问</span></p>
			</div>
			...
			<div class="detai-fun mar-com">
				<div class="f-left fun-left">
					<div class="detail-left f-left">
						<a href="javascript:void(0);" num="${shareInfoBean.likeNum}" class="praise">
							<img id="praiseImg"src="${imagePath}/publish/zan.png" >
							<span id="praiseCount">${shareInfoBean.likeNum}</span>
						</a>
					
						<a href="javascript:void(0);" num="${shareInfoBean.collectionNum}" class="collection">
                       		<img src="${imagePath}/publish/shou.png" >
		...
		<div class="content">
			<div class="con-left f-left">
				<div class="detail-com">
					<div class="com-logo f-left"><img class="headerimg" src="" alt="" link="${headUrl}"></div>
					<div class="com-text">
						<textarea name="" id="commentTxt" cols="30" rows="5" maxlength="100" placeholder="回复@${shareInfoBean.realName}"></textarea>
						<p><a href="javascript:void(0);" id="commentBtn"><span>发布</span></a></p>
					</div>
				</div>
			...
			<div class="con-right f-right">
				<div class="inter-case ">
					<h4>最热门的话题</h4>
					<div class="case-list">
					     <div class="case-list" id="ask_infos_Content"> 
					         <!-- <input type='hidden' id="searchType" value='1'/>所有 -->
					         <input type='hidden' id="shareType" value='5'/><!-- yiwen-->
			             </div>
						<!-- <div class="case-list-content">
							<p class="case-desc"><em>[骨科]</em>开放性骨折的治疗原则与方法原则与方法</p>
							<p class="case-name"><span>由<em>卡戴珊</em>发布</span><span class="f-right">04-14 19:49</span></p>
						</div>
						<div class="case-list-content">
							<p class="case-desc"><em>[骨科]</em>开放性骨折的治疗原则与方法原则与方法</p>
							<p class="case-name"><span>由<em>卡戴珊</em>发布</span><span class="f-right">04-14 19:49</span></p>
