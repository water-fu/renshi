...
<%@ include file="/WEB-INF/pages/common/header.jsp" %>
		...
		<div class="answ-detail">
			...
			<div class="detail-time mar-com">
				<p><a href="${path}/blog/${shareInfoBean.accountId}"><strong>${shareInfoBean.realName}</strong></a><span>发布于<em><fmt:formatDate value="${shareInfoBean.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></em>的病例</span></p>
			</div>
				  ...
				  <div class="case-list">
					<div class="case-list" id="case_infos_Content"> 
					  <!--  <input type='hidden' id="searchType" value='1'/>所有 -->
					   <input type='hidden' id="shareType" value='3'/><!-- 视频-->
			        </div>
