...
<%@ include file="/WEB-INF/pages/common/header.jsp" %>
		...
		<div class="answ-detail">
			<div class="detail-title mar-com">
				...
				<ul class="f-right">
					...
					<li><span>${shareInfoBean.readNum}</span><em>播放</em></li>
				</ul>
			</div>
			<div class="detail-time mar-com">
				<p><a href="${path}/blog/${shareInfoBean.accountId}"><strong>${shareInfoBean.realName}</strong></a><span>发布于<em><fmt:formatDate value="${shareInfoBean.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/> </em>的视频</span></p>
			</div>
		...
		<div class="content">
			...
			<div class="con-right f-right">
			 ...
			 <div class="case-list" id="case_infos_Content"> 
					...
					<input type='hidden' id="shareType" value='1'/><!-- 视频-->
						...
						<!-- <div class="case-list-content">
							...
							<div class="f-right">
								...
								<p class="case-name"><span>由<em>卡戴珊</em>发布</span></p>	
							</div>
						</div>
						<div class="case-list-content">
							<div class="f-left"><img src="#" alt=""></div>
				 ...
				 <div class="a-meet hidden "><!-- hidden -->
					<img src="#" alt="">
				</div> 
				<div class="a-ad">
					ad
		...
		<!-- content end -->
		<!-- <div class="case-list" id="case_infos_Content"></div> -->
